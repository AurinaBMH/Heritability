...
function [G,  PhiNormMean, dMiddle] = giveMeRichClub(matrices, COG, groupMatrixType, densThreshold, giveRC, CVmeasure, consThr, numIter, numRepeats, whatTypeNetwork ,whatNullModel,scaling)
...
[~, dMiddle, PhiNormMean] = PlotRichClub(G,mdist,whatTypeNetwork,whatNullModel,numIter,numRepeats,scaling, mCon);
end
