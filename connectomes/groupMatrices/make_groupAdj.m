...
tract = 'FACT'; % FACT vs iFOD2
sift = 'SIFT2'; 
weight = 'FA'; % specify weight to be used:
% FA
% standard
% density
% MD
groupMatrixType = 'consistency'; % specify type of group matrix
% 'variance' - Robert's method
% 'consistency' - VDH method
% 'lengthCV' - Misic's method
threshold = 0.6; % consistency threshold 
...
elseif strcmp(groupMatrixType, 'variance')
    G = giveMeGroupAdj_variance(connectomes); 
