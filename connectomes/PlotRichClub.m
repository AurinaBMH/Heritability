function [dMiddleNorm, dMiddle, PhiNormMean, PhiTrue, PhiRand]=PlotRichClub(Adj,DISTmean, WhatTypeNetwork,whatNullModel,numIter,numRepeats, scaling, mCon)
%-------------------------------------------------------------------------------
...
[PhiNorm,PhiTrue,PhiRand] = RichClubPhiNorm(Adj,kmax, numIter,numRepeats,WhatTypeNetwork,whatNullModel, DISTmean, mCon); %, doBins);
